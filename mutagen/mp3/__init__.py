...
class MPEGFrame(object):
    ...
    __BITRATE = {
        ...
        (1.0, 2): [0, 32, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320, 384],
        (1.0, 3): [0, 32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320],
        (2.0, 1): [0, 32, 48, 56, 64, 80, 96, 112, 128, 144, 160, 176, 192, 224, 256],
        (2.0, 2): [0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160],
    }
...
class MP3(ID3FileType):
    ...
    def score(filename, fileobj, header_data):
        ...
        return (
            (
                header_data.startswith(b'ID3')
                or header_data.startswith(b'\xff\xf2')
                or header_data.startswith(b'\xff\xf3')
                or header_data.startswith(b'\xff\xfa')
                or header_data.startswith(b'\xff\xfb')
            )
            * 2
