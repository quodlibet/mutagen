...
"AENC", "APIC", "ASPI", "BUF", "CHAP", "CNT", "COM", "COMM", "COMR", "CRA", "CRM",
"CTOC", "ENCR", "EQU2", "ETC", "ETCO", "GEO", "GEOB", "GP1", "GRID", "GRP1", "IPL",
"IPLS", "LINK", "LNK", "MCDI", "MCI", "MLL", "MLLT", "MVI", "MVIN", "MVN", "MVNM",
"OWNE", "PCNT", "PCST", "PIC", "POP", "POPM","POSS", "PRIV","RBUF", "REV", "RVA",
"RVA2", "RVAD", "RVRB", "SEEK", "SIGN", "SLT", "STC", "SYLT", "SYTC", "TAL", "TALB",
"TBP", "TBPM", "TCAT", "TCM", "TCMP", "TCO", "TCOM", "TCON", "TCOP", "TCP", "TCR",
"TDA", "TDAT", "TDEN", "TDES", "TDLY", "TDOR", "TDRC", "TDRL", "TDTG", "TDY", "TEN",
"TENC", "TEXT", "TFLT", "TFT", "TGID", "TIM", "TIME", "TIPL", "TIT1", "TIT2", "TIT3",
"TKE", "TKEY", "TKWD", "TLA", "TLAN", "TLE", "TLEN", "TMCL", "TMED", "TMOO", "TMT",
"TOA", "TOAL", "TOF", "TOFN", "TOL", "TOLY", "TOPE", "TOR", "TORY", "TOT", "TOWN",
"TP1", "TP2", "TP3", "TP4", "TPA", "TPB", "TPE1", "TPE2", "TPE3", "TPE4", "TPOS",
"TPRO", "TPUB", "TRC", "TRCK", "TRD", "TRDA", "TRK", "TRSN", "TRSO", "TS2", "TSA",
"TSC", "TSI", "TSIZ", "TSO2", "TSOA",
"TSOC", "TSOP", "TSOT", "TSP", "TSRC", "TSS", "TSSE", "TSST", "TST", "TT1", "TT2",
"TT3", "TXT", "TXX",
"TXXX", "TYE", "TYER", "UFI", "UFID", "ULT", "USER", "USLT", "WAF", "WAR", "WAS", "WCM",
"WCOM", "WCOP",
