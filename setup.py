...
Ogg Vorbis, and FLAC, and writing ID3v1.1, ID3v2.4, APEv2, Ogg Vorbis,
and FLAC. It can also read MPEG audio and Xing headers, FLAC stream
info blocks, and Ogg Vorbis identification headers.
"""
    )
