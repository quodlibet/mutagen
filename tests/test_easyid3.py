...
class TEasyID3(TestCase):
    ...
    def test_write_invalid(self):
        ...
        self.failUnlessRaises(ValueError, self.id3.__setitem__, 'notvalid', 'tests')
    ...
    def test_bad_trackid(self):
        self.failUnlessRaises(
            ValueError, self.id3.__setitem__, 'musicbrainz_trackid', ['a', 'b']
        )
    ...
    def test_gain_peak_get(self):
        ...
        self.failUnlessEqual(self.id3['replaygain_foo_gain'], ['+3.500000 dB'])
        self.failUnlessEqual(self.id3['replaygain_foo_peak'], ['0.000000'])
        self.failUnlessEqual(self.id3['replaygain_bar_gain'], ['+0.000000 dB'])
    ...
    def test_text_tags(self):
        for tag in ['albumartist', 'performer']:
            ...
            self.id3.save(self.filename)
            id3 = EasyID3(self.filename)
            self.failUnlessEqual(id3[tag], ['foo'])
