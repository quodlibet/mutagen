...
class TAPEInvalidItemCount(TestCase):
    ...
    def test_load(self):
        x = mutagen.apev2.APEv2(os.path.join(DATA_DIR, '145-invalid-item-count.apev2'))
...
class TAPEWriter(TestCase):
    ...
    def test_changed(self):
        ...
        self.tag.save()
        self.failUnlessEqual(os.path.getsize(self.sample_new), size - self.offset)
    ...
    def test_fix_broken(self):
        ...
        self.failUnlessEqual(os.path.getsize(OLD), os.path.getsize(self.broken_new))
    ...
    def test_delete(self):
        ...
        self.failUnlessEqual(
            os.path.getsize(SAMPLE) + self.offset, os.path.getsize(self.sample_new)
        )
        self.failIf(tag)

    def test_empty(self):
        self.failUnlessRaises(
            APEv2Error, mutagen.apev2.APEv2, os.path.join(DATA_DIR, 'emptyfile.mp3')
        )
    ...
    def test_tag_at_start_delete(self):
        ...
        self.failUnlessEqual(os.path.getsize(filename), len('tag garbage') * 1000)
...
class TAPEv2(TestCase):
    ...
    def test_invalid_key(self):
        self.failUnlessRaises(KeyError, self.audio.__setitem__, '\u1234', 'foo')
    ...
    def test_no_tag(self):
        self.failUnlessRaises(
            MutagenError, mutagen.apev2.APEv2, os.path.join(DATA_DIR, 'empty.mp3')
        )
    ...
    def test_keys(self):
        ...
        self.failUnlessEqual(
            self.audio.items(), list(zip(self.audio.keys(), self.audio.values()))
        )
...
class TAPEv2WithLyrics2(TestCase):
    def setUp(self):
        self.tag = mutagen.apev2.APEv2(os.path.join(DATA_DIR, 'apev2-lyricsv2.mp3'))
...
class TAPEBinaryValue(TestCase):
    ...
    def test_type2(self):
        self.assertRaises(
            TypeError, mutagen.apev2.APEValue, 'abc', mutagen.apev2.BINARY
        )
...
class TAPETextValue(TestCase):
    ...
    def setUp(self):
        ...
        self.value = mutagen.apev2.APEValue('\0'.join(self.sample), mutagen.apev2.TEXT)
    ...
    def test_types(self):
        ...
        self.assertRaises(TypeError, mutagen.apev2.APEValue, b'abc', mutagen.apev2.TEXT)
...
class TAPEExtValue(TestCase):
    ...
    def setUp(self):
        ...
        self.value = mutagen.apev2.APEValue(self.sample, mutagen.apev2.EXTERNAL)
    ...
    def test_py3(self):
        self.assertRaises(
            TypeError, mutagen.apev2.APEValue, b'abc', mutagen.apev2.EXTERNAL
        )
