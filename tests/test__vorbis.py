...
class TVComment(TestCase):
    ...
    def test_unset_framing_bit(self):
        self.failUnlessRaises(error, VComment, b'\x00\x00\x00\x00' * 2 + b'\x00')
    ...
    def test_invalid_format_strict(self):
        data = b'\x07\x00\x00\x00Mutagen\x01\x00\x00\x00\x03\x00\x00\x00abc\x01'
    ...
    def test_invalid_tag_strict(self):
        data = b'\x07\x00\x00\x00Mutagen\x01\x00\x00\x00\x04\x00\x00\x00\xc2\xaa=c\x01'
        self.failUnlessRaises(error, VComment, data, errors='strict')
...
class TVCommentDict(TestCase):
    ...
    def test_bad_key(self):
        ...
        self.failUnlessRaises(ValueError, self.c.__setitem__, '\u1234', 'foo')
        self.failUnlessRaises(ValueError, self.c.__delitem__, '\u1234')
