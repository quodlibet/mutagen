...
class TMid3Iconv(_TTools):
    ...
    def test_debug(self):
        ...
        self.assertTrue("TCON=Silence" in out)
    ...
    def test_test_data(self):
        ...
        self.assertEqual(len(results), len(CODECS))
    ...
    def test_conv_basic(self):
        ...
        for codec in CODECS:
            ...
            f = ID3(self.filename)
            self.assertEqual(f["TALB"].encoding, 1)
            self.assertEqual(f["TALB"].text[0], AMBIGUOUS.decode(codec))
    ...
    def test_comm(self):
        ...
        for codec in CODECS:
            ...
            self.assertEqual(new_frame.encoding, 1)
            self.assertEqual(new_frame.text[0], AMBIGUOUS.decode(codec))
    ...
    def test_remove_v1(self):
        ...
        with open(self.filename, "rb") as h:
            ...
            self.assertFalse(ParseID3v1(data))
