...
class BitPaddedIntTest(TestCase):
    ...
    def test_zero(self):
        self.assertEqual(BitPaddedInt(b'\x00\x00\x00\x00'), 0)

    def test_1(self):
        self.assertEqual(BitPaddedInt(b'\x00\x00\x00\x01'), 1)
    ...
    def test_129(self):
        self.assertEqual(BitPaddedInt(b'\x00\x00\x01\x01'), 0x81)

    def test_129b(self):
        self.assertEqual(BitPaddedInt(b'\x00\x00\x01\x81'), 0x81)

    def test_65(self):
        self.assertEqual(BitPaddedInt(b'\x00\x00\x01\x81', 6), 0x41)
    ...
    def test_s1(self):
        self.assertEqual(BitPaddedInt.to_str(1), b'\x00\x00\x00\x01')
    ...
    def test_s129(self):
        self.assertEqual(BitPaddedInt.to_str(129), b'\x00\x00\x01\x01')

    def test_s65(self):
        self.assertEqual(BitPaddedInt.to_str(0x41, 6), b'\x00\x00\x01\x01')

    def test_w129(self):
        self.assertEqual(BitPaddedInt.to_str(129, width=2), b'\x01\x01')
    ...
    def test_varwidth(self):
        ...
        self.assertEqual(len(BitPaddedInt.to_str(100, width=-1)), 4)
        self.assertEqual(len(BitPaddedInt.to_str(2 ** 32, width=-1)), 5)
    ...
    def test_has_valid_padding(self):
        self.assertTrue(BitPaddedInt.has_valid_padding(b"\xff\xff", bits=8))
        self.assertFalse(BitPaddedInt.has_valid_padding(b"\xff"))
        self.assertFalse(BitPaddedInt.has_valid_padding(b"\x00\xff"))
        self.assertTrue(BitPaddedInt.has_valid_padding(b"\x7f\x7f"))
        self.assertFalse(BitPaddedInt.has_valid_padding(b"\x7f", bits=6))
        self.assertFalse(BitPaddedInt.has_valid_padding(b"\x9f", bits=6))
        self.assertTrue(BitPaddedInt.has_valid_padding(b"\x3f", bits=6))

        self.assertTrue(BitPaddedInt.has_valid_padding(0xff, bits=8))
        self.assertFalse(BitPaddedInt.has_valid_padding(0xff))
        self.assertFalse(BitPaddedInt.has_valid_padding(0xff << 8))
        self.assertTrue(BitPaddedInt.has_valid_padding(0x7f << 8))
        self.assertFalse(BitPaddedInt.has_valid_padding(0x9f << 32, bits=6))
        self.assertTrue(BitPaddedInt.has_valid_padding(0x3f << 16, bits=6))
