...
class TAC3(TestCase):
    ...
    def test_type(self):
        self.failUnlessEqual(self.ac3.info.type_, "AC3")
        self.failUnlessEqual(self.eac3.info.type_, "EAC3")
    ...
    def test_pprint(self):
        self.assertTrue("AC3" in self.ac3.pprint())
        self.assertTrue("EAC3" in self.eac3.pprint())
