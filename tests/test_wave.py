...
class TWave(TestCase):
    def setUp(self):
        fn_wav_pcm_2s_16000_08_id3v23 = os.path.join(
            DATA_DIR, 'silence-2s-PCM-16000-08-ID3v23.wav'
        )
        self.wav_pcm_2s_16000_08_ID3v23 = WAVE(fn_wav_pcm_2s_16000_08_id3v23)

        self.tmp_fn_pcm_2s_16000_08_ID3v23 = get_temp_copy(
            fn_wav_pcm_2s_16000_08_id3v23
        )
        self.tmp_wav_pcm_2s_16000_08_ID3v23 = WAVE(self.tmp_fn_pcm_2s_16000_08_ID3v23)

        self.fn_wav_pcm_2s_16000_08_notags = os.path.join(
            DATA_DIR, 'silence-2s-PCM-16000-08-notags.wav'
        )
        self.wav_pcm_2s_16000_08_notags = WAVE(self.fn_wav_pcm_2s_16000_08_notags)

        self.tmp_fn_pcm_2s_16000_08_notag = get_temp_copy(
            self.fn_wav_pcm_2s_16000_08_notags
        )
        self.tmp_wav_pcm_2s_16000_08_notag = WAVE(self.tmp_fn_pcm_2s_16000_08_notag)

        fn_wav_pcm_2s_44100_16_id3v23 = os.path.join(
            DATA_DIR, 'silence-2s-PCM-44100-16-ID3v23.wav'
        )
    ...
    def test_bits_per_sample(self):
        self.failUnlessEqual(self.wav_pcm_2s_16000_08_ID3v23.info.bits_per_sample, 8)
        self.failUnlessEqual(self.wav_pcm_2s_44100_16_ID3v23.info.bits_per_sample, 16)

    def test_bitrate(self):
        self.failUnlessEqual(self.wav_pcm_2s_16000_08_ID3v23.info.bitrate, 256000)
        self.failUnlessEqual(self.wav_pcm_2s_44100_16_ID3v23.info.bitrate, 1411200)
    ...
    def test_not_my_file(self):
        self.failUnlessRaises(InvalidChunk, WAVE, os.path.join(DATA_DIR, 'empty.ogg'))
    ...
    def test_picard_lifecycle(self):
        path_tmp_wav_file = get_temp_copy(self.fn_wav_pcm_2s_16000_08_notags)
    ...
    def __init_id3_tags(id3, major=3):
        ...
        id3.add(
            TXXX(encoding=major, desc='MusicBrainz Album Release Country', text='US')
        )
        ...
        id3.add(
            TXXX(encoding=major, desc='Artists', text=['Beth Hart', 'Joe Bonamassa'])
        )
